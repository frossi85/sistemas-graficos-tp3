    ...
    static class Renderer implements GLEventListener
    {
        ...
        public void init(GLAutoDrawable gLDrawable)
        {
            ...
            try
            {
                ...
                //model = ModelFactory.createModel("model/examples/models/max3ds/apollo.3ds");
                //model = ModelFactory.createModel("model/examples/models/max3ds/avenger.3ds");
                //model = ModelFactory.createModel("model/examples/models/obj/penguin.obj");
